...
type LocalInvoice = { id: string; invoice_number: string; client_id: string; client_name: string; total: number; paid_amount: number; due_date: string; created_at: string };
...
export const listFallbackInvoices = async () => (await read()).invoices;
